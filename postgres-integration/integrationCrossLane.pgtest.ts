...
describe('M2-M5 integration: migration chain from an empty database', () => {
  test('0001-0122 domain lanes plus M6/M7/M8/M9 apply in exact lane order; unused allocations stay unused', async () => {
    ...
    try {
      ...
      assert.deepEqual(inLane('M9'), [120, 121, 122], 'M9 additive extensions: 0120 re-plan identity, 0121/0122 FIG-3 evaluation-lifecycle revision (lane/wit-live-readmodel-contract)');
