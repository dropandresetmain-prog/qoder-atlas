...
describe('M2-M5 integration: migration chain from an empty database', () => {
  test('0001-0113 domain lanes plus M6/M7/M8 apply in exact lane order; unused allocations stay unused', async () => {
    ...
    try {
      ...
      assert.deepEqual(inLane('M8'), contiguous(109, 113), 'M8 used 0109-0113; 0114-0119 reserved');
