...
const originalStart = '2026-09-29T08:00:00+09:00';
const originalEnd = '2026-10-01T11:00:00+09:00';
const world = (): CapturedWorld => ({
  ...
  intendedVisits: [{ id: 'visit-a', journeyId: 'journey-a', jurisdictionId: 'jurisdiction-a', purpose: 'business visit', intended: { start: '2026-09-28T00:00:00Z', end: '2026-10-03T00:00:00Z' }, transitIntent: false }],
  ...
  transportServices: [
    { id: 'service-original', revision: 1, mode: 'FLIGHT', operator: 'carrier-a', originPlaceId: 'airport-a', destinationPlaceId: 'hotel-place-a', published: { departure: null, arrival: { value: '2026-09-28T21:00:00Z', observedAt: '2026-09-01T00:00:00Z', evidenceId: 'e-original' } }, estimated: { departure: null, arrival: null }, actual: { departure: null, arrival: null } },
    { id: 'service-replacement', revision: 1, mode: 'FLIGHT', operator: 'carrier-b', originPlaceId: 'airport-a', destinationPlaceId: 'hotel-place-a', published: { departure: null, arrival: { value: '2026-09-29T23:00:00Z', observedAt: '2026-09-01T00:00:00Z', evidenceId: 'e-replacement' } }, estimated: { departure: null, arrival: null }, actual: { departure: null, arrival: null } },
  ],
  resources: [],
  ...
  placeJurisdictions: [{ placeId: 'hotel-place-a', jurisdictionId: 'jurisdiction-a', basis: 'AREA_MEMBERSHIP', areaVersionId: 'area-a', evidenceId: 'e-place' }],
...
test('builds a same-property replacement for a changed arrival date without mutating the captured world', () => {
  ...
  assert.equal(result.replacement.query.checkOutDate, '2026-10-01');
...
test('does not accept a selected service for a different destination', () => {
  const captured = world();
  captured.transportServices.push({ ...captured.transportServices[1]!, id: 'service-wrong-place', destinationPlaceId: 'airport-a' });
