...
**Revisit when:** G3R-R1 transaction-safety review accepts the Mission 1 candidate (adapter/executor implemented on `wave3r/runtime-execution`, pending review); wider carrier/route coverage sampling belongs to DR-9 scenario selection.
