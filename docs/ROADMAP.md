...
**Revisit when:** G3R-R0 is independently accepted and DR-2 schedules the Atlas transactional adapter mapping (bounded sandbox execution available without jeopardising core delivery).
