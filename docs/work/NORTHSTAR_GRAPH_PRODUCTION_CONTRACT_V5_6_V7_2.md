...
Post-R4 revalidation: [A0 reconciliation](ASTRA_A0_CONVERGENCE.md), accepted base
`2baf1f6df484319e131590d37a0b026222324d03`. The graph production paths did not
change between this audited snapshot and final R4; physical fidelity remains
unproven until A1. Audit provenance below is preserved.
