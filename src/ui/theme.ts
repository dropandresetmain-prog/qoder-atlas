...
.b-dot.d-unconfirmed { background: var(--neutral-f); border: 1px solid var(--neutral-border); }
.b-dot.d-local { background: rgba(150, 103, 15, 0.35); border: 1px solid rgba(150, 103, 15, 0.25); }
