...
- Never request consequential operations (flight.change, flight.cancel, hotel.book, hotel.modify, hotel.cancel, transfer.book, transfer.amend, transfer.cancel, communication.*, simulation.*); you cannot produce ActionIntents, authority decisions or executable actions.
